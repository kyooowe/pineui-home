const HomePage = () => {
	return (
		<div className="h-screen bg-[#0e1217]">
			<div
			...
			>
				...
				<div className="mt-2 max-w-3xl text-center mx-auto">
					<h1 className="block font-black bg-clip-text bg-gradient-to-br from-blue-500 via-indigo-600 to-violet-600 text-transparent text-7xl sm:text-9xl">
						Pine UI
					</h1>
				</div>

				<div className="max-w-md mt-2 text-center mx-auto">
					<p className="text-lg text-white xs:text-sm">
						🚀 Dive into the Next.js boilerplate for PineUI and supercharge your web development! Enjoy a swift and seamless setup that empowers you to create modern, high-performance web apps with ease.
					</p>
				</div>
				<div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
					<a
						href="https://github.com/kyooowe/PineUI"
						className="inline-flex justify-center items-center gap-x-3 text-center bg-gradient-to-tl from-blue-600 via-indigo-600 to-violet-600 hover:bg-gradient-to-tr hover:from-violet-600 hover:via-indigo-600 hover:to-blue-600 border border-transparent text-white text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 focus:ring-offset-2 focus:ring-offset-white py-3 px-4 dark:focus:ring-offset-gray-800 transition"
					>
						<svg
				...
				<div className="mt-5 flex justify-center items-center gap-1 sm:gap-x-2">
					<span className="text-sm font-bold text-gray-900 dark:text-white">NextJS</span>
					...
					<span className="text-sm font-bold text-gray-900 dark:text-white">TRPC</span>
					<svg className="h-5 w-5 text-gray-300 dark:text-gray-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
						<path d="M6 13L10 3" stroke="currentColor" strokeLinecap="round" />
					</svg>
					<span className="text-sm font-bold text-gray-900 dark:text-white">Prisma</span>
					<svg className="h-5 w-5 text-gray-300 dark:text-gray-600" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
						<path d="M6 13L10 3" stroke="currentColor" strokeLinecap="round" />
					</svg>
